...
# Link back to the intake app, shown on every generated PDF.
TOOL_URL = os.getenv(
    "SCAT6_TOOL_URL",
...
def build_scat6_pdf(assessment: Dict, scores: Dict) -> bytes:
    ...
    story.append(Paragraph(
        ...
        SMALL))
    story.append(Paragraph(
        f'<link href="{TOOL_URL}" color="#2f6fb2"><u>Go to SCAT6 Tool</u></link>', BODY))
    ...
    story.append(Paragraph(
        ...
        "2023;57:622–631. An athlete can score within normal limits on the SCAT6 and "
        "still have a concussion.", SMALL))
